...
(defn start-fresh
  ...
  (tx (publishers/read-publishers "publishers.edn"))

  (tx [{:db/id            [:bgg/id 173346]
        :game/summary     "Science? Military? What will you draft to win this head-to-head version of 7 Wonders?"
        :game/description "In many ways 7 Wonders Duel resembles its parent game 7 Wonders as over three ages players acquire cards that provide resources or advance their military or scientific development in order to develop a civilization and complete wonders.
